...
namespace UtilsCore
{
    ...
    public class ChinaDateHelper
    {
        ...
        public static ChinaDate GetChinaDate(DateTime dt)
        {
            ...
            foreach (string s in sFtv)
            {
                ...
                if (s1.Equals(smd))
                {
                    cd.SolarFtv = s.Substring(4, s.Length - 4);
                    break;
                }
            }
            foreach (string s in lFtv)
            {
                ...
                if (s1.Equals(lmd))
                {
                    cd.LunarFtv = s.Substring(4, s.Length - 4);
                    break;
                }
            }
            dt = dt.AddDays(1);
            ...
            if (lmd.Equals("0101")) cd.LunarFtv = "除夕";
            return cd;
        }
        #endregion
    }
    ...
    public class ChinaDate
    {
        ...
        /// 阴历节日
        /// </summary>
        public string LunarFtv = "";
        /// <summary>
        /// 阳历节日
        /// </summary>
        public string SolarFtv = "";
    }
    ...
    public class ChineseCalendar
    {
        ...
        public string NewCalendarHoliday
        {
            ...
            {
                string tempStr = "";
                if (_cIsLeapMonth) return tempStr;
                foreach (LunarHolidayStruct lh in LHolidayInfo)
                {
                    if ((lh.Month != _cMonth) || (lh.Day != _cDay)) continue;
                    tempStr = lh.HolidayName;
                    break;
                }

                //对除夕进行特别处理
                if (_cMonth != 12) return tempStr;
            ...
            get
            {
                switch (this._cDay)
                {
                    ...
                    case 30:
                        return "三十";
                    default:
                        return nStr2[(int)(_cDay / 10)] + nStr1[_cDay % 10].ToString();
